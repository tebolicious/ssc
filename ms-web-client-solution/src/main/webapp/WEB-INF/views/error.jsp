...
<head>
	...
	<title>spring-microservices-solution: Error</title>
</head>
...
<body>
	...
	<div class="container">
		...
		<div class="row">
			...
			<h1>Accounts Web - Error</h1>

			<c:if test="${not empty status}" >
				<p>HTTP Response Status: ${status}</p>
			</c:if>
	
			<c:if test="${not empty message && message != 'No message available'}">
				<p>${message}</p>
			</c:if>
